...
class WhisperAttention(nn.Module):
    ...
    def __init__(
        ...
        config: dict = None, #Optional[WhisperConfig]
    ):
        super().__init__()
...
class WhisperSdpaAttention(WhisperAttention):
    ...
    def forward(
        ...
        attn_output = torch.nn.functional.scaled_dot_product_attention(
            ...
            dropout_p=self.dropout if self.training else 0.05,
...
class WhisperEncoder(nn.Module): #WhisperPreTrainedModel
    """
...
class WhisperForAudioClassification(WhisperPreTrainedModel):
    def __init__(self, config):
        ...
        #self.projector = nn.Linear(config.hidden_size, 2048)
    ...
    def forward(
        ...
        logits = hidden_states#self.projector(hidden_states)
